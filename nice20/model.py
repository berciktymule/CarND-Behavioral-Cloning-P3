...
throttle = []
control = []
base_data_path = ['../corrections/', '../slow_data/', '../data_ud/']#', '../session_data/', '../track2/', '../take2/', '../take2_other_way/','../slow_data/'  ]
...
model = Sequential()
model.add(Cropping2D(cropping=((26,9), (0,0)), input_shape=(64,64,3)))
